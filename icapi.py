...
class ScheduleItem:
    def __init__(self, schedule_data):
        self.subject = schedule_data['subject']
        self.period = schedule_data['period']
        self.teacher = schedule_data['teacher']
        self.start_time = schedule_data['startDateTime']
        self.end_time = schedule_data['endDateTime']
...
class User(RestClient):
    ...
    def getSchedule(self):
        ...
        result = self.api_request('GET', "resources/portal/roster")
        items = [User.ScheduleItem(item) for item in result]
        return items

    def getInformation(self):
        self.log("Recieved information")
        result = self.api_request('GET', "resources/my/userAccount")
        return result
